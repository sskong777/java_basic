		...
		while(true) {
			...
			if(choice ==1 ) {
				...
				Loop1 : while(true) {	//while문 이름 지정
					...
					System.out.println("## 1.전체메뉴 보기  2.돈 충전 ##");
					System.out.println();
					System.out.println("## 3.커피 주문  4.잔액 확인  5.나가기##");
					System.out.println("################################");
					System.out.println();
				...
				Loop2 : while(true) {
					...
					case 4:
						...
						break;
					case 5:
						System.out.println("알바한테 맡기고 나갑니다");
						break Loop2;	// while문을 빠져나간다
						default:
							System.out.println("잘못 입력하였습니다");
							continue;
					}
